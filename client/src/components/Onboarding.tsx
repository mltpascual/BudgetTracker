...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      iconColor: "#22c55e",
      iconBg: "#dcfce7",
      title: t("onboardingExpenses"),
      description: t("onboardingExpensesDesc"),
    ...
    },
    {
      ...
      iconColor: "#8b5cf6",
      iconBg: "#ede9fe",
      title: t("onboardingBudgets"),
      description: t("onboardingBudgetsDesc"),
    ...
    },
    {
      ...
      iconColor: "#f97316",
      iconBg: "#fff7ed",
      title: t("onboardingBackup"),
      description: t("onboardingBackupDesc"),
      ...
      >
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex gap-2">
            ...
            >
              {isLast ? t("onboardingStart") : t("next")}
