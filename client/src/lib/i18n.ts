...
const en = {
  ...
  landingPreviewHeading: "Looks polished, feels easy, and makes sense right away.",
  landingPreviewDesc: "The experience is built around real money workflows: home snapshots, wallet visibility, spending insights, and the important things coming up next.",
  landingFeaturesHeading: "Everything you need to feel clear about your money.",
  landingFeaturesSubDesc: "From wallet tracking and budgets to debt management, analytics, and local backup — the app is built to cover the full day-to-day money picture.",
...
const fil: TranslationKeys = {
  ...
  landingPreviewHeading: "Mukhang polished, madaling gamitin, at naiintindihan agad.",
  landingPreviewDesc: "Ang experience ay ginawa para sa totoong money workflows: home snapshots, wallet visibility, spending insights, at mga importanteng bagay na paparating.",
  landingFeaturesHeading: "Lahat ng kailangan mo para maging malinaw ang pera mo.",
  landingFeaturesSubDesc: "Mula sa wallet tracking at budgets hanggang debt management, analytics, at local backup — ginawa ang app para i-cover ang buong day-to-day money picture mo.",
